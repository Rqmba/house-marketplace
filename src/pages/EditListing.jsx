...
function EditListing() {
  ...
  const onSubmit = async (e) => {
    ...
    if (discountedPrice >= regularPrice) {
      setLoading(false);
      toast.error("Le prix promotionnel doit être inférieur au prix de base");
      return;
    }
    ...
    setLoading(false);
    toast.success("Annonce sauvegardé");
  ...
  return (
    <div className="profile">
      <header>
        <p className="pageHeader">Editer une annonce</p>
      </header>
      ...
      <main>
        <form onSubmit={onSubmit}>
          ...
          <div className="formRooms flex">
            ...
            <div>
              <label className="formLabel">Salles de bains</label>
              <input
                className="formInputSmall"
                type="number"
                id="bathrooms"
          ...
          <label className="formLabel">Meublée</label>
          <div className="formButtons">
            <button
          ...
          {offer && (
            <>
              <label className="formLabel">Prix promotionnel</label>
              <input
                className="formInputSmall"
                type="number"
                id="discountedPrice"
